...
namespace CashierSystem
{
    ...
    public partial class findrecnum : Form
    {
        ...
        public findrecnum()
        {
            ...
            var carm = Application.OpenForms["recchoose"] as recchoose;
            gunaLabel5.Text = carm.guna2TextBox1.Text;
            loaddata();
            showord();
            calctotaasnaf();
        ...
        private void findrecnum_Load(object sender, EventArgs e)
        {
        ...
        {
            if (MessageBox.Show("هل أنت متأكد من حذف هذه الفاتورة؟", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                
                qu = "DELETE FROM orders WHERE recnum=$ida";
