...
{
    public partial class takawatdel : Form
    {
        ...
        private void takawatdel_Load(object sender, EventArgs e)
        {
        ...
        public void loadcapt()
        {
            ...
            cmd.Parameters.AddWithValue("$do", "دليفرى");
            using (SqliteDataReader read = cmd.ExecuteReader())
            {
                while (read.Read())
                {
